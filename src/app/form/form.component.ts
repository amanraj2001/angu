...
export class FormComponent {
  ...
  array: string[] = ['uncle', 'aunt', 'cousin', 'Friend']
  ...
  addfield() {
    ...
    this.emgList.push(new FormGroup({
      Relation: new FormControl(),
      Num: new FormControl()
    }))
  }
  ...
  addData() {
    ...
    if (typeof this.studentform.value.name?.firstname == 'string' && typeof this.studentform.value.name?.middlename == 'string' && typeof this.studentform.value.name?.lastname == 'string' && typeof this.studentform.value.Dob == 'string' && typeof this.studentform.value.placeofbirth == 'string' && typeof this.studentform.value.Firstlang == 'string' && typeof this.studentform.value.Address?.city == 'string' && typeof this.studentform.value.Address?.state == 'string' && typeof this.studentform.value.Address?.country == 'string' && typeof this.studentform.value.Address?.pin == 'string' && typeof this.studentform.value.father_name?.firstname == 'string' && typeof this.studentform.value.father_name?.middlename == 'string' && typeof this.studentform.value.father_name?.lastname == 'string' && typeof this.studentform.value.father_name?.email == 'string' && typeof this.studentform.value.father_name?.Educationqual == 'string' && typeof this.studentform.value.father_name?.profession == 'string' && typeof this.studentform.value.father_name?.designation == 'string' && typeof this.studentform.value.father_name?.phone == 'string' && typeof this.studentform.value.mother_name?.firstname == 'string' && typeof this.studentform.value.mother_name?.middlename == 'string' && typeof this.studentform.value.mother_name?.lastname == 'string' && typeof this.studentform.value.mother_name?.email == 'string' && typeof this.studentform.value.mother_name?.Educationqual == 'string' && typeof this.studentform.value.mother_name?.profession == 'string' && typeof this.studentform.value.mother_name?.designation == 'string' && typeof this.studentform.value.mother_name?.phone == 'string') {
      ...
      ({ 
          name: { 
          firstname: this.studentform.value.name?.firstname, 
          middlename: this.studentform.value.name?.middlename, 
          lastname: this.studentform.value.name?.lastname 
        }, 
        Dob: this.studentform.value.Dob, 
        placeofbirth: this.studentform.value.placeofbirth, 
        Firstlang: this.studentform.value.Firstlang, 
        Address: { 
          city: this.studentform.value.Address?.city, 
          state: this.studentform.value.Address?.state, 
          country: this.studentform.value.Address?.country, 
          pin: this.studentform.value.Address?.pin 
        }, 
        father_name: { 
          firstname: this.studentform.value.father_name?.firstname, 
          middlename: this.studentform.value.father_name?.middlename, 
          lastname: this.studentform.value.father_name?.lastname, 
          email: this.studentform.value.father_name?.email, 
          Educationqual: this.studentform.value.father_name?.Educationqual, 
          profession: this.studentform.value.father_name?.profession, 
          designation: this.studentform.value.father_name?.designation, 
          phone: this.studentform.value.father_name?.phone 
        }, 
        mother_name: { 
          firstname: this.studentform.value.mother_name?.firstname,
           middlename: this.studentform.value.mother_name?.middlename, 
           lastname: this.studentform.value.mother_name?.lastname, 
           email: this.studentform.value.mother_name?.email, 
           Educationqual: this.studentform.value.mother_name?.Educationqual, 
           profession: this.studentform.value.mother_name?.profession, 
           designation: this.studentform.value.mother_name?.designation, 
           phone: this.studentform.value.mother_name?.phone 
          }, 
          emergency_contactlist: [...this.emgList.value], 
          reference: [...this.ref.value] 
        })
    }
